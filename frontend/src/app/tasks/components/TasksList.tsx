...
export default function TasksList({ initialTasks, viewMode = "grid" }: TasksListProps) {
      ...
      render: (value: string) => (
        <div className="flex flex-col gap-1 text-xs text-muted-foreground">
          <div className="flex items-center gap-1.5">
            ...
            <span>{new Date(value).toLocaleDateString('en', {
              day: 'numeric',
              month: 'short',
              year: 'numeric'
            })}</span>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span>{new Date(value).toLocaleTimeString('ru-RU', {
              hour: '2-digit',
              minute: '2-digit'
            })}</span>
          </div>
