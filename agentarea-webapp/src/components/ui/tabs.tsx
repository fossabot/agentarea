...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-lg bg-sidebar p-1 text-[#C7C7D1] transition-all duration-300 dark:bg-zinc-800",
      className
    )}
    {...props}
  />
